...
var _ = Describe("Schema", func() {
	...
	BeforeEach(func() {
		...
		exampleVMI.Spec.Domain.Devices.BlockMultiQueue = v12._true
		...
		exampleVMI.Spec.Domain.Features = &v12.Features{
			ACPI:       v12.FeatureState{Enabled: v12._false},
			SMM:        &v12.FeatureState{Enabled: v12._true},
			APIC:       &v12.FeatureAPIC{Enabled: v12._true},
			KVM:        &v12.FeatureKVM{Hidden: true},
			Pvspinlock: &v12.FeatureState{Enabled: v12._false},
			Hyperv: &v12.FeatureHyperv{
				Relaxed:         &v12.FeatureState{Enabled: v12._true},
				VAPIC:           &v12.FeatureState{Enabled: v12._false},
				Spinlocks:       &v12.FeatureSpinlocks{Enabled: v12._true},
				VPIndex:         &v12.FeatureState{Enabled: v12._false},
				Runtime:         &v12.FeatureState{Enabled: v12._true},
				SyNIC:           &v12.FeatureState{Enabled: v12._false},
				SyNICTimer:      &v12.SyNICTimer{Enabled: v12._true, Direct: &v12.FeatureState{Enabled: v12._true}},
				Reset:           &v12.FeatureState{Enabled: v12._false},
				VendorID:        &v12.FeatureVendorID{Enabled: v12._true, VendorID: "vendor"},
				Frequencies:     &v12.FeatureState{Enabled: v12._false},
				Reenlightenment: &v12.FeatureState{Enabled: v12._false},
				TLBFlush:        &v12.FeatureState{Enabled: v12._true},
			},
		}
